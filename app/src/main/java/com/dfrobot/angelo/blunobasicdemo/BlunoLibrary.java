...
//	}
	...
	public abstract void onSerialReceived(byte[] bytes) throws InterruptedException;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
            	...
            	{
            		if (new String(intent.getByteArrayExtra(BluetoothLeService.EXTRA_DATA)).toUpperCase().startsWith("DF BLUNO")) {
                    ...
                    try {
                        onSerialReceived(intent.getByteArrayExtra(BluetoothLeService.EXTRA_DATA));
